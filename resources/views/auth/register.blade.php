                ...
                <div class="col-lg-4">
                    ...
                    <form class="mt-3" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group" v-if="is_store_open">
                            ...
                            <input v-model="store_name" id="store_name" type="text" class="form-control @error('store_name') is-invalid @enderror" name="store_name" value="{{ old('store_name') }}" required autocomplete="store_name" autofocus>
                            @error('name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
